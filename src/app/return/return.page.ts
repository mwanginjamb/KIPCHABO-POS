...
export class ReturnPage implements OnInit, OnDestroy {
  ...
  Key: string;
    ...
    ngOnInit() {
      ...
      this.setUser();
      if(!this.Key){
        console.log(`create was called at init illegally..............`);
        this.CreateReturn(); 
      }else {
        console.log(`Fetch By Key Called Legally.`);
    ...
    ionViewWillEnter() {
      this.setUser();
      if(this.Key) {
        console.log(`Will enter run well........`);
        // this.FetchReturnByKey(this.Key);
      }
    }
